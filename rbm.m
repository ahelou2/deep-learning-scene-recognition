...
for epoch = 1:maxepoch
    ...
    for batch = 1:numbatches
        ...
        %go up one more time
        % WARNING: negdatastates might need to be replaced to negdata!
        ...
        %Note: Only sparsifying b as recommended by "Sparse deep belief net
        %model for visual area V2"
        db = db - 2*lambda*B*D ;
    ...
    if (vis_fantasy == true)
        figure(1); 
        dispims(negdatastates(1:10,:)',vis_fantasy_height,vis_fantasy_width);
        drawnow
    end
end
